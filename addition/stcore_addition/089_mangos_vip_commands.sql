...
INSERT INTO `mangos_string` VALUES (12000, 'You can\'t use command while being dead/stealthed or being in arena/bg or being in combat.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Вы не можете использовать комманду находясь на арене/БГ, в комбате/стелсе или будучи мертвым.');
INSERT INTO `mangos_string` VALUES (12001, 'You can\'t use command while being dead/stealthed or being in arena/bg or being in combat.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Вы не можете использовать комманду находясь на арене/БГ/подземелье, в комбате/стелсе или будучи мертвым.')
